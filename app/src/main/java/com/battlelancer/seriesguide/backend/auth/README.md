...
account is silently changed to Google sign-in, preventing sign in with email. The workaround is to
delete the account in Firebase Authentication and re-create it (Cloud data is preserved).
