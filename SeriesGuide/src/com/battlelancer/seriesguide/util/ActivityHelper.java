...
public class ActivityHelper {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                goHome();
                return true;
                // decide later if we include a global search button, currently
                // plans to filter based on search location
    ...
    // /**
    // * Sets up the action bar with the given title and accent color. If title
    // is
    ...
    // }
    //
    // LinearLayout.LayoutParams springLayoutParams = new
    ...
    // actionBar.findViewById(R.id.actionbar_compat_text);
    // if (titleText != null) {
    // titleText.setText(title);
    // }
    // }
    ...
    // separator
    // .setLayoutParams(new ViewGroup.LayoutParams(2,
    // ViewGroup.LayoutParams.FILL_PARENT));
    //
    // // Create the button
