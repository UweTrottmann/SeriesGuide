...
public class AnalyticsUtils {
     ...
     */
    private static final String UACODE = "UA-3577058-7";
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    Log.d(TAG, "SeriesGuide Analytics trackEvent: " + category + " / " + action
                            + " / " + label + " / " + value);
                } catch (Exception e) {
                    // We don't want to crash if there's an Analytics library
                    // exception.
                    Log.w(TAG, "SeriesGuide Analytics trackEvent error: " + category + " / "
                            + action + " / " + label + " / " + value, e);
                }
                return null;
            }
        }.execute();
