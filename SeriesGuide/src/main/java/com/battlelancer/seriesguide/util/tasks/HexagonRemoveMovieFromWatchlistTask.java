...
public class HexagonRemoveMovieFromWatchlistTask extends BaseHexagonMovieTask {

    public HexagonRemoveMovieFromWatchlistTask(Context context, int movieTmdbId) {
