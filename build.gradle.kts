...
buildscript {
    ...
    val sgVersionCode by extra(2106001)
    val sgVersionName by extra("60-beta1")

    val kotlin_version by extra("1.5.10") // https://kotlinlang.org/docs/releases.html#release-details
