...
public interface IncomingConstants {
    ...
    String EXTRA_SUBSCRIBER_COMPONENT = "com.battlelancer.seriesguide.api.extra.SUBSCRIBER_COMPONENT";
    String EXTRA_TOKEN = "com.battlelancer.seriesguide.api.extra.TOKEN";
